...
#define WIN32_STRING					L"\\\\.\\CtrSpy"

#define FILE_ACCESS_READ_ONLY	0x00000001
...
#define IOCTL_SET_PROTECT_REG_PATH			CTL_CODE (FILE_DEVICE_UNKNOWN, (0x800 + 0x09B), METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SET_PROCESS_PROTECT_ONOFF		CTL_CODE (FILE_DEVICE_UNKNOWN, (0x800 + 0x09C), METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SET_REG_PROTECT_ONOFF			CTL_CODE (FILE_DEVICE_UNKNOWN, (0x800 + 0x09D), METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SET_FILE_PROTECT_ONOFF		CTL_CODE (FILE_DEVICE_UNKNOWN, (0x800 + 0x09E), METHOD_BUFFERED, FILE_ANY_ACCESS)
